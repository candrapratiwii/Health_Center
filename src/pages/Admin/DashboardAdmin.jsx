  ...
  return (
    ...
    >
      <div
        ...
        style={{ padding: 30, marginLeft: 0, minHeight: "100vh" }}
      >
              ...
              {loadingChart ? (
                <div
                  ...
                  style={{
                    width: "100%",
                    height: "100%",
                    background: "linear-gradient(135deg, #2dd4bf20, #14b8a620)",
                    borderRadius: 15,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                >
                  ...
                  <div>Memuat data kunjungan pasien...</div>
                </div>
              ) : (
                <ReactApexChart
                  options={{
                    ...
                    plotOptions: {
                      bar: {
                        borderRadius: 8,
                        columnWidth: "60%", // lebih tebal
                        distributed: false,
                      },
                    },
                    dataLabels: { enabled: false },
                    grid: { borderColor: "#e0e7ef", strokeDashArray: 4 },
                    colors: ["#1890ff"], // biru seperti chart laporan
                    tooltip: {
            ...
            {quickStats.map((q, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{ fontSize: 28, fontWeight: "bold", color: "#2dd4bf" }}
                >
                  {q.value}
                </div>
                <div style={{ color: q.color, fontSize: 14, marginTop: 5 }}>
                  {q.desc}
                </div>
              </div>
            ))}
        ...
        >
          ...
          >
            {activities.map((a, i) => (
              ...
              >
                <div
                  className={`activity-icon ${a.iconClass}`}
                  style={{
                    width: 40,
                    height: 40,
                    borderRadius: "50%",
                    ...
                    color: "white",
                    background:
                      a.iconClass === "appointment"
                        ? "#3b82f6"
                        : a.iconClass === "registration"
                        ? "#10b981"
                        : a.iconClass === "medicine"
                        ? "#f59e0b"
                        : "#8b5cf6",
                  }}
                >
